...
<div class="container py-10 flex flex-col md:flex-row"
    style=" background-image: linear-gradient(rgba(0,0,0,0.8),rgba(0,0,0,0.8)),url({{$movie['backdrop_path']}});background-size: cover;">
...
<div class="flex-none">
    <img style="margin-right: 120px" class="w-64 lg:w-96 movie-img"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            " href="#">
                    <img src="{{ 'https://image.tmdb.org/t/p/w500/'.$image['file_path']}}" alt="image1"
                        class="hover:opacity-75 transition ease-in-out duration-150 images-movie">
                </a>
        </div>
        @endforeach
    </div>
