...
<header class="showcase">
    <div class="showcase-content">
        <h1>See out Movie List</h1>
        <p>More Movies, More Entertain</p>
        <a href="#" style="border-radius: 20px;box-shadow: 3px -4px rgb(237 208 208 / 40%);" class="btn btn-xl">Please enjoy our Movie List from TMDB
